...
func NewCandidateListResponse() *CandidateListResponse {
  return &CandidateListResponse{}
}


func (p *CandidateListResponse) GetCandidates() []*Candidate {
  return p.Candidates
}
func (p *CandidateListResponse) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *CandidateListResponse)  ReadField1(iprot thrift.TProtocol) error {
...
func (p *CandidateListResponse) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("CandidateListResponse"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
  }
...
func (p *CandidateListResponse) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *CandidateListResponse) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("CandidateListResponse(%+v)", *p)
}
