...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  CandidateListResponse GetCandidateList(CandidateListRequest req)")
  fmt.Fprintln(os.Stderr, "  CandidateDetailResponse GetCandidateDetail(CandidateDetailRequest req)")
  fmt.Fprintln(os.Stderr, "  DelegatorCandidateListResponse GetDelegatorCandidateList(DelegatorCandidateListRequest req)")
