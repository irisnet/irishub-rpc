...
var IRISHubService_SaveDelegatorStakeExRate_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined && args.req !== null) {
      this.req = new model_ttypes.DelegatorStakeExRateRequest(args.req);
    }
  }
};
IRISHubService_SaveDelegatorStakeExRate_args.prototype = {};
IRISHubService_SaveDelegatorStakeExRate_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.req = new model_ttypes.DelegatorStakeExRateRequest();
        this.req.read(input);
      } else {
        input.skip(ftype);
      }
...
IRISHubService_SaveDelegatorStakeExRate_args.prototype.write = function(output) {
  output.writeStructBegin('IRISHubService_SaveDelegatorStakeExRate_args');
  if (this.req !== null && this.req !== undefined) {
    output.writeFieldBegin('req', Thrift.Type.STRUCT, 1);
    this.req.write(output);
    output.writeFieldEnd();
...
var IRISHubService_SaveDelegatorStakeExRate_result = function(args) {
  this.e = null;
  if (args instanceof model_ttypes.Exception) {
    this.e = args;
    return;
...
IRISHubService_SaveDelegatorStakeExRate_result.prototype = {};
IRISHubService_SaveDelegatorStakeExRate_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
IRISHubService_SaveDelegatorStakeExRate_result.prototype.write = function(output) {
  output.writeStructBegin('IRISHubService_SaveDelegatorStakeExRate_result');
  if (this.e !== null && this.e !== undefined) {
    output.writeFieldBegin('e', Thrift.Type.STRUCT, 1);
    this.e.write(output);
    output.writeFieldEnd();
...
IRISHubServiceClient.prototype.SaveDelegatorStakeExRate = function(req, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_SaveDelegatorStakeExRate(req);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_SaveDelegatorStakeExRate(req);
...
IRISHubServiceClient.prototype.send_SaveDelegatorStakeExRate = function(req) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('SaveDelegatorStakeExRate', Thrift.MessageType.CALL, this.seqid());
  var params = {
    req: req
  };
  var args = new IRISHubService_SaveDelegatorStakeExRate_args(params);
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
};

IRISHubServiceClient.prototype.recv_SaveDelegatorStakeExRate = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new IRISHubService_SaveDelegatorStakeExRate_result();
  result.read(input);
  input.readMessageEnd();
...
IRISHubServiceProcessor.prototype.process_SaveDelegatorStakeExRate = function(seqid, input, output) {
  var args = new IRISHubService_SaveDelegatorStakeExRate_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.SaveDelegatorStakeExRate.length === 1) {
    Q.fcall(this._handler.SaveDelegatorStakeExRate.bind(this._handler), args.req)
      .then(function(result) {
        var result_obj = new IRISHubService_SaveDelegatorStakeExRate_result({success: result});
        output.writeMessageBegin("SaveDelegatorStakeExRate", Thrift.MessageType.REPLY, seqid);
        result_obj.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result;
        if (err instanceof model_ttypes.Exception) {
          result = new IRISHubService_SaveDelegatorStakeExRate_result(err);
          output.writeMessageBegin("SaveDelegatorStakeExRate", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
          output.writeMessageBegin("SaveDelegatorStakeExRate", Thrift.MessageType.EXCEPTION, seqid);
        }
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.SaveDelegatorStakeExRate(args.req, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof model_ttypes.Exception) {
        result_obj = new IRISHubService_SaveDelegatorStakeExRate_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("SaveDelegatorStakeExRate", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("SaveDelegatorStakeExRate", Thrift.MessageType.EXCEPTION, seqid);
