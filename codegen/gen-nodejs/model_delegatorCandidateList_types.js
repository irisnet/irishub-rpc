...
var DelegatorCandidateListResponse = module.exports.DelegatorCandidateListResponse = function(args) {
  this.candidates = null;
  if (args) {
    if (args.candidates !== undefined && args.candidates !== null) {
      this.candidates = Thrift.copyList(args.candidates, [model_common_ttypes.Candidate]);
    }
  }
};
DelegatorCandidateListResponse.prototype = {};
DelegatorCandidateListResponse.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem6 = null;
          elem6 = new model_common_ttypes.Candidate();
          elem6.read(input);
...
DelegatorCandidateListResponse.prototype.write = function(output) {
  output.writeStructBegin('DelegatorCandidateListResponse');
