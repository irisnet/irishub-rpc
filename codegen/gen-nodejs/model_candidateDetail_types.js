...
var CandidateDetailResponse = module.exports.CandidateDetailResponse = function(args) {
  this.candidate = null;
  if (args) {
    if (args.candidate !== undefined && args.candidate !== null) {
      this.candidate = new model_common_ttypes.Candidate(args.candidate);
    }
  }
};
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        this.candidate = new model_common_ttypes.Candidate();
