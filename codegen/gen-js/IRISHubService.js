...
IRISHubService_GetAccountNum_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined && args.req !== null) {
      this.req = new AccountNumRequest(args.req);
    }
  }
};
IRISHubService_GetAccountNum_args.prototype = {};
IRISHubService_GetAccountNum_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.req = new AccountNumRequest();
        this.req.read(input);
      } else {
        input.skip(ftype);
      }
...
IRISHubService_GetAccountNum_args.prototype.write = function(output) {
  output.writeStructBegin('IRISHubService_GetAccountNum_args');
  if (this.req !== null && this.req !== undefined) {
    output.writeFieldBegin('req', Thrift.Type.STRUCT, 1);
    this.req.write(output);
    output.writeFieldEnd();
...
IRISHubService_GetAccountNum_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof Exception) {
    this.e = args;
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new AccountNumResponse(args.success);
    }
    if (args.e !== undefined && args.e !== null) {
      this.e = args.e;
    }
...
IRISHubService_GetAccountNum_result.prototype = {};
IRISHubService_GetAccountNum_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new AccountNumResponse();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
IRISHubService_GetAccountNum_result.prototype.write = function(output) {
  output.writeStructBegin('IRISHubService_GetAccountNum_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
IRISHubServiceClient.prototype.GetAccountNum = function(req, callback) {
  this.send_GetAccountNum(req, callback); 
  if (!callback) {
    return this.recv_GetAccountNum();
  }
};

IRISHubServiceClient.prototype.send_GetAccountNum = function(req, callback) {
  this.output.writeMessageBegin('GetAccountNum', Thrift.MessageType.CALL, this.seqid);
  var params = {
    req: req
  };
  var args = new IRISHubService_GetAccountNum_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_GetAccountNum();
      } catch (e) {
        result = e;
      }
      callback(result);
...
IRISHubServiceClient.prototype.recv_GetAccountNum = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  var result = new IRISHubService_GetAccountNum_result();
  result.read(this.input);
  this.input.readMessageEnd();
  ...
  throw 'GetAccountNum failed: unknown result';
};
