...
AccountNumRequest = function(args) {
  this.address = null;
  if (args) {
    if (args.address !== undefined && args.address !== null) {
      this.address = args.address;
...
AccountNumRequest.prototype = {};
AccountNumRequest.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
AccountNumRequest.prototype.write = function(output) {
  output.writeStructBegin('AccountNumRequest');
  if (this.address !== null && this.address !== undefined) {
    output.writeFieldBegin('address', Thrift.Type.STRING, 1);
    output.writeString(this.address);
    output.writeFieldEnd();
...
AccountNumResponse = function(args) {
  this.accountNum = null;
  if (args) {
    if (args.accountNum !== undefined && args.accountNum !== null) {
      this.accountNum = args.accountNum;
    }
  }
};
AccountNumResponse.prototype = {};
AccountNumResponse.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I64) {
        this.accountNum = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AccountNumResponse.prototype.write = function(output) {
  output.writeStructBegin('AccountNumResponse');
  if (this.accountNum !== null && this.accountNum !== undefined) {
    output.writeFieldBegin('accountNum', Thrift.Type.I64, 1);
    output.writeI64(this.accountNum);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
